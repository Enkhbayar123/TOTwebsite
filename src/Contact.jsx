            ...
            <div className="lg:col-span-2 bg-[#0c4a6e] text-white p-10 md:p-14 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-12">
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4"><div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-[#0284c7] shrink-0"><Mail size={20} /></div><div><p className="text-xs font-bold uppercase text-slate-400 tracking-wider mb-1">Email</p><a href="mailto:emily.hooper@onecollective.org" className="text-lg font-medium hover:text-[#0284c7] transition-colors">emily.hooper@onecollective.org</a></div></div>
